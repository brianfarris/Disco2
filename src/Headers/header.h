...
enum{VORTEX,TORUS,BONDI,UNIFORM,SHOCK1,SHOCK2,SHOCK3,SHOCK4,ISENTROPE,GBONDI,GBONDI2,EQUIL1,EQUIL2,SSDISC,NTDISC,CNSTDISC,CARTSHEAR,DISCTEST,ACCDISC,ADAF};
...
//Equations of State
enum{EOS_IDEAL_NEWT,EOS_IDEAL_GR};
//Cooling Schemes
enum{COOL_NONE,COOL_ISOTHERM,COOL_BB_ES,COOL_BB_FF,COOL_NU};
