...
enum{VORTEX,TORUS,BONDI,UNIFORM,SHOCK1,SHOCK2,SHOCK3,SHOCK4,ISENTROPE,GBONDI,
  ...
  ADAF2,ATMO,ORBIT,MINIDISC,KICK};
...
//Metric Types
enum{SR,SCHWARZSCHILD_SC,SCHWARZSCHILD_KS,SR_CART,KERR_KS,SR_ADM,
    SCHWARZSCHILD_KS_ADM};
//Frames
...
//Boosting Effects
enum{BOOST_NONE, BOOST_RIGID, BOOST_BIN};
