...
enum{FLOCK,SHEAR,VORTEX,STONE,FIELDLOOP,PSIGRAD,TORUS,MILOS_MACFADYEN,MHDEXP,VISCRING,TESTING,DIVERGENCE,RAD_DOM,MIDDLE,SSTEST,CDMIGRATION, MMRINGCAV, FULVCDMIGRATION};
