...
enum{A_FIXED,A_KEPLER,A_OMEGA20,A_MILOS,A_POWERLAW, A_CORED_KEPLER};
enum{LEFT,LEFTSTAR,RIGHTSTAR,RIGHT};
enum{EULER,MHD};
enum{VAR_INT,VAR_DOUB,VAR_STR};
enum{BOUND_FIXED,BOUND_OUTFLOW,BOUND_PERIODIC};
enum{FLOCK,SHEAR,VORTEX,STONE,FIELDLOOP,PSIGRAD,TORUS,MILOS_MACFADYEN,MHDEXP,VISCRING,TESTING,DIVERGENCE,RAD_DOM,MIDDLE,SSTEST,CDMIGRATION, MMRINGCAV, FULVCDMIGRATION, SIMPKEP};
