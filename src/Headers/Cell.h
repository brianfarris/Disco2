...
double *cell_single_get_prims(struct Cell *);
struct Cell *cell_pointer(struct Cell ***,int,int,int);
double cell_tiph(struct Cell ***,int,int,int);
double cell_single_tiph(struct Cell *);
double cell_dphi(struct Cell ***,int,int,int);
double cell_single_dphi(struct Cell *);
