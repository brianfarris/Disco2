...
//initial data
void cell_init_shear(struct Cell ***,struct Sim *,struct GravMass *, struct MPIsetup *);
void cell_single_init_shear(struct Cell *, struct Sim *,struct GravMass *,int ,int ,int );
void cell_init_vortex(struct Cell ***,struct Sim *,struct GravMass *, struct MPIsetup *);
void cell_single_init_vortex(struct Cell *, struct Sim *,struct GravMass *,int ,int ,int );
void cell_init_torus(struct Cell ***,struct Sim *,struct GravMass *, struct MPIsetup *);
void cell_single_init_torus(struct Cell *, struct Sim *,struct GravMass *,int ,int ,int );
void cell_init_milos_macfadyen(struct Cell ***,struct Sim *,struct GravMass *, struct MPIsetup *);
void cell_single_init_milos_macfadyen(struct Cell *, struct Sim *,struct GravMass *,int ,int ,int );
void cell_init_rad_dom(struct Cell ***,struct Sim *,struct GravMass *, struct MPIsetup *);
void cell_single_init_rad_dom(struct Cell *, struct Sim *,struct GravMass *,int ,int ,int );
void cell_init_middle(struct Cell ***,struct Sim *,struct GravMass *, struct MPIsetup *);
...
void cell_init_flock(struct Cell ***,struct Sim *,struct GravMass *, struct MPIsetup *);
void cell_single_init_flock(struct Cell *, struct Sim *,struct GravMass *,int ,int ,int );
...
void cell_boundary_fixed_r( struct Cell ***, struct Sim *,struct GravMass *,struct MPIsetup *,void (*)(struct Cell *,struct Sim *,struct GravMass *,int,int,int));
