 ...
 if (timestep_get_t(theTimeStep)>diagnostics_tdiag_measure(theDiagnostics)){
    ...
    */
    ...
    if(mpisetup_MyProc(theMPIsetup)==0){
      ...
      fprintf(DiagBpFile,"%e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e \n",t, r_bh0, r_bh1, a_bin, phi_bh0, phi_bh1, ecc, E, Ltot, Om, vr0, vr1, M0, M1, Pow_reduce, gravMass_total_torque(theGravMasses,0), TrScal_reduce, Fr_onBin, Fp_onBin, e_1, e_2);
      fclose(DiagBpFile);
    }
