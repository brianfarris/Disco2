...
void LR_speed_grvisc1(double *prim, double r, int *n ,double GAMMALAW, double *p_vn, double *p_cf2, double *Fm, double *p_mn)
{
    double P   = prim[PPP];
    double rho = prim[RHO];
    double vr  = prim[URR];
...
void riemann_set_vel_grvisc1(struct Riemann *theRiemann, struct Sim *theSim, double r, double GAMMALAW)
{
    int i, dir;
...
void riemann_set_flux_grvisc1(struct Riemann *theRiemann, struct Sim *theSim, double GAMMALAW, int SetState)
{
