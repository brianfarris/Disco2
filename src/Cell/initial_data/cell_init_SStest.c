...
void cell_single_init_SStest(struct Cell *theCell, struct Sim *theSim,struct GravMass * theGravMasses,int i,int j,int k){
  ...
  double vr     = 0.0;// -3.*alpha/r/omega*P/rho*(2.+r_drP_o_P);
...
void cell_init_SStest(struct Cell ***theCells,struct Sim *theSim,struct GravMass * theGravMasses,struct MPIsetup * theMPIsetup) {
