...
void cell_single_init_MMRingCav_old(struct Cell *theCell, struct Sim *theSim,int i,int j,int k){
...
void cell_init_MMRingCav_old(struct Cell ***theCells,struct Sim *theSim,struct MPIsetup * theMPIsetup) {
